...
def prepare_common_parser(parser, data_path, output_file):
    ...
    parser.add_argument('--ml_embedding_file_names', nargs='*',
                        default=['embeddings.pickle', 'embeddings_cpc.pickle', 'embeddings_cpcv2.pickle'])
    parser.add_argument('--target_score_file_names', nargs='*',
                        default=['target_scores', 'finetuning_scores', 'finetuning_cpc_scores'])
