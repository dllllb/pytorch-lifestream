...
class SWA(Optimizer):
    def __init__(self, optimizer, swa_start=None, swa_freq=None, swa_lr=None):
        ...
        BASED on oficial impementation from package torchcontrib
    ...
    @staticmethod
    def bn_update(loader, model, device=None, prepare_batch=None):
        ...
        for batch in loader:
            if prepare_batch is not None:
                input, _ = prepare_batch(batch, device, True)
