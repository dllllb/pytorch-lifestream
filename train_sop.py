...
from dltranz.sop import SOPModel, SOPDataset, ConvertingTrxDataset, collate_splitted_pairs
...
def create_data_loaders(conf):
    ...
    train_dataset = SOPDataset(train_dataset)

    train_loader = DataLoader(
        dataset=train_dataset,
        shuffle=True,
        collate_fn=collate_splitted_pairs,
    ...
    valid_dataset = SOPDataset(valid_dataset)
