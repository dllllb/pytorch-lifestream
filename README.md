...
| 2.1. | Event sequence for global problems      | Event sequence classifacation           | tbd |
| 2.2. | Event sequence for local problems       | Next event prediction                   | tbd |
| 4.     | Supervised neural networks              | Supervised learning for event sequence classification  | [demo/supervised-sequence-to-target.ipynb](./demo/supervised-sequence-to-target.ipynb)  |
| 4.1.   | Network Types                           | Different networks for sequences      |  |
| 4.1.1. | Recurrent neural networks               |    | tbd based on `supervised-sequence-to-target.ipynb` |
| 4.1.2. | (optional) Convolutonal neural networks |    | tbd based on `supervised-sequence-to-target.ipynb` |
| 4.1.3. | Transformers                            |    | tbd based on `supervised-sequence-to-target.ipynb` |
| 4.2.   | Problem types                           | Different problems typed for sequences  |  |
| 4.2.1. | Global problems                         | Binary, multilabel, regression, ...   | tbd based on [demo/multilabel-classification.ipynb](demo/multilabel-classification.ipynb) | 
| 4.2.2. | Local problems                          | Next event prediction                 | tbd |
| 5.   | Unsupervised learning                   | Pretrain foundation model with some pretrain task | tbd based on [demo/coles-emb.ipynb](./demo/coles-emb.ipynb)  [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dllllb/pytorch-lifestream/blob/master/demo/coles-emb.ipynb)     |
| 5.1. | (optional) word2vec                     | Context based methods                   |     |
| 5.2. | mlm, rtd, gpt                           | Event bases methods                     | Self-supervided training and embeddings for clients' transactions [notebook](event-sequence-local-embeddings.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dllllb/pytorch-lifestream/blob/master/demo/event-sequence-local-embeddings.ipynb) |
| 5.3. | nsp, sop                                | Sequence based methods                  | tbd |
| 6.   | Contrasvive and non contrastive learing | Latent representation based losses      | tbd based on [demo/coles-emb.ipynb](./demo/coles-emb.ipynb)             |
| 6.1. | coles                                   |    | [demo/coles-emb.ipynb](./demo/coles-emb.ipynb)                |
| 6.2. | vicreg                                  |    | tbd based on [demo/coles-emb.ipynb](./demo/coles-emb.ipynb)                   |
| 6.3. | cpc                                     |    | tbd based on [demo/coles-emb.ipynb](./demo/coles-emb.ipynb)                   |
| 6.4. | mlm and others                          | Self-supervised TrxEncoder only training with Masked Language Model | tbd based on [demo/mlm-emb.ipynb](./demo/mlm-emb.ipynb)                   |
| 7.   | Pretrained model usage                  |    |    |
| 7.1. | Downstream model on frozen embeddings   |    | tbd based on [demo/coles-emb.ipynb](./demo/coles-emb.ipynb)  |
| 7.2. | CatBoost embeddings features            |    | [demo/coles-catboost.ipynb](demo/coles-catboost.ipynb) |
| 7.3. | Model finetuning                        |    | [demo/coles-finetune.ipynb](./demo/coles-finetune.ipynb) |
| 8.   | Preprocessing options                   | Data preparation demos | [demo/preprocessing-demo.ipynb](demo/preprocessing-demo.ipynb) |
| 8.1  | ptls-format parquet data loading        | PySpark and Parquet for data preprocessing | [demo/pyspark-parquet.ipynb](demo/pyspark-parquet.ipynb) |
| 8.2. | Fast inference for big dataset          |    | [demo/extended_inference.ipynb](demo/extended_inference.ipynb) |
| 9.   | Features special types                  |    |    | 
| 9.1. | Using pretrained encoder to text features |  | [demo/coles-pretrained-embeddings.ipynb](demo/coles-pretrained-embeddings.ipynb) | 
| 9.2  | Multi source models                     |    | [demo/CoLES-demo-multimodal-unsupervised.ipynb](demo/CoLES-demo-multimodal-unsupervised.ipynb) |
